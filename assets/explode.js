...
* @param {string} letter
*/
export function explode_letter(letter) {
    wasm.explode_letter(letter.codePointAt(0));
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_random_07b2df1a129f4f17 = typeof Math.random == 'function' ? Math.random : notDefined('Math.random');
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('explode_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
